<div class="container">
  <div class="modal fade" id="m_task" role="dialog" data-easein="bounceRightIn"  tabindex="-1" aria-labelledby="costumModalLabel" aria-hidden="true">
    ...
    <div class="col-md-8">
     ...
     <div class="form-group row">
       <label class="control-label col-sm-2" for="email">Periode:</label>
         <div class="col-sm-4">
           <input type="text" class="form-control datepicker form-control-sm" name="from_task" placeholder="From">
         </div>
         <div class="col-sm-4">
           <input type="text" class="form-control datepicker form-control-sm" name="to_task" placeholder="To">
         </div>
       </div>
     </form>
     <div class="form-group row">
           ...
           <select class="form-control" name="sel_st">
             <option value="" class="form-control">Please Select</option> -->
               ...
               while($data_st   = $q_status->fetch_array()){
                 echo '<option value="'.$data_st[st_task].'" class="form-control  form-control-sm">'.ucwords(status($data_st[st_task])[0]).'</option>';
               }
               ?>
         </select>
         </div>
    ...
    <div class="table-responsive">
      <table id="table_task" class="table table-striped table-hover datatables" >
        ...
        if($_POST['b_priode']){
          ...
          // <td> $subject |$nama_task_cat | $nama_sub_cat</td><td>$no</td>
            ...
            <td> $ext</td>
                  ...
                  <td>
                    <div class='btn-group btn-group-sm'>
                      <button type='button' class='btn btn-primary dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'> ".ucwords(status($st_task)[0])."
                      </button>
                      <div class='dropdown-menu' >
                        <a class='dropdown-item' href='javascript:void(0)' value='1' data-id='$data[id_task]'>Open</a>
                        <a class='dropdown-item' href='javascript:void(0)' value='2' data-id='$data[id_task]'>Process</a>
                        <a class='dropdown-item' href='javascript:void(0)' value='3' data-id='$data[id_task]'>Done</a>
                        <a class='dropdown-item' href='javascript:void(0)' value='4' data-id='$data[id_task]'>Close</a>
                       </div>
                     </div>
                  </td>
