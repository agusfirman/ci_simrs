...
<div class="row">
	...
	<div class="col-6 col-md-2 col-xl d-flex">
		<div class="card flex-fill">
			<div class="card-body">
						<?php
						$result_count = $mysqli->query("SELECT COUNT(*) as jumlah_task FROM `task` ");
						$data_count_task   = $result_count->fetch_array();
						extract($data_count_task);
						echo "<h4>$jumlah_task</h4>";
						?>
			...
			<div class="card-body py-2">
				<div class="row">
					<div class="col-6 col-md-6 align-self-center text-center text-md-left">
						<?php
						$result_count_task_done = $mysqli->query("SELECT COUNT(*) as jumlah_task_done FROM `task` where st_task=3 ");
						$data_count_task_done   = $result_count_task_done->fetch_array();
						extract($data_count_task_done);
						$persen_done =round($jumlah_task_done/$jumlah_task*100,2);
						echo "<h4>$jumlah_task_done</h4>";
						?>
						<p class="mb-0">TASK DONE</p>
					</div>
					<div class="col-6 col-md-6 align-self-center text-center text-md-right">
						<div data-label="<?php echo $persen_done;?>%" class="doughnut mt-2 doughnut-primary doughnut-<?php echo ceil($persen_done);?>"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card flex-fill">
			<div class="card-body py-2">
				<div class="row">
					<div class="col-6 col-md-6 align-self-center text-center text-md-left">
						<?php
						$result_count_task_proccess = $mysqli->query("SELECT COUNT(*) as jumlah_task_proccess FROM `task` where st_task=2 ");
						$data_count_task_proccess   = $result_count_task_proccess->fetch_array();
						extract($data_count_task_proccess);
						$persen_proccess=round($jumlah_task_proccess/$jumlah_task * 100,2);
						echo "<h4>$jumlah_task_proccess</h4>";
						?>
						<p class="mb-0">TASK PROCCESS</p>
					</div>
					<div class="col-6 col-md-6 align-self-center text-center text-md-right">
						<div data-label="<?php echo $persen_proccess; ?>%" class="doughnut mt-2 doughnut-warning doughnut-<?php echo ceil($persen_proccess); ?>"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card flex-fill">
			<div class="card-body py-2">
				<div class="row">
					<div class="col-6 col-md-6 align-self-center text-center text-md-left">
						<?php
						$result_count_task_open = $mysqli->query("SELECT COUNT(*) as jumlah_task_open FROM `task` where st_task=1 ");
						$data_count_task_open   = $result_count_task_open->fetch_array();
						extract($data_count_task_open);
						$persen_open=round($jumlah_task_open/$jumlah_task * 100,2);
						echo "<h4>$jumlah_task_open</h4>";
						?>
						<p class="mb-0">TASK OPEN</p>
					</div>
					<div class="col-6 col-md-6 align-self-center text-center text-md-right">
						<div data-label="<?php echo $persen_open;?>%" class="doughnut mt-2 doughnut-danger doughnut-<?php echo ceil($persen_open);?>"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card flex-fill">
			<div class="card-body py-2">
				<div class="row">
					<div class="col-6 col-md-6 align-self-center text-center text-md-left">
						<?php
						$result_count_task_close = $mysqli->query("SELECT COUNT(*) as jumlah_task_close FROM `task` where st_task=4 ");
						$data_count_task_close   = $result_count_task_close->fetch_array();
						extract($data_count_task_close);
						$persen_close=round($jumlah_task_close/$jumlah_task * 100,2);
						echo "<h4>$jumlah_task_close</h4>";
						?>
						<p class="mb-0">TASK CLOSE</p>
					</div>
					<div class="col-6 col-md-6 align-self-center text-center text-md-right">
						<div data-label="<?php echo $persen_close;?>%" class="doughnut mt-2 doughnut-danger doughnut-<?php echo ceil($persen_close);?>"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card flex-fill w-100">
			...
			<div class="card-body">
				<div class="chart">
					...
					// print_r(json_encode($jumlah_bln_2017));
