...
<table id="table_pr" class="table table-bordered table-striped datatables display">
    <thead>
     <tr class="bg-orange">
        <th>No</th>
        <th>Lokasi</th>
...
<div class="well">
     Jumlah data pemakaian Printer seluruh ruangan
     <span class="badge">
     <?php
      $sql_jml =$mysqli->query( "select sum(jumlah_pr) as jumlah from printer ");
