...
<div class="box-body">
	...
	echo "
		...
		<li><a href='index.php?page=". base64_encode('setoran_bank')."&form=". base64_encode('form-bca-new')." '>
			<i class='fa fa-money'></i> BCA NEW</a></li>
		...
		<li><a href='index.php?page=". base64_encode('setoran_bank')."&form=". base64_encode('form-bri')." '>
				<i class='fa fa-money'></i> BRI</a></li>
		<li><a href='index.php?page=". base64_encode('setoran_bank')."&form=". base64_encode('set_font')." '>
				<i class='fa fa-gear'></i> Setting Fonts</a></li>
