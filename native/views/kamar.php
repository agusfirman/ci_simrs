...
<div class="box-body">
    ...
    <?php
      ...
      if($foto !=""){
      	...
      	$t_foto = "
		<button class='btn btn-success btn-sm btn-dm t_foto btn-flat' data-id='$id_room'>Upload Foto</button>";
      }
        echo"<tr>
           <td>$no</td>
	        <td>$nama_room</td>
	        ...
	        <td>
	           <a href='#' onclick='' class='e_kamar' data-id='$id_room'>
					<i class='fa fa-pencil-square-o'></i>
				</a>|
				<a href='javascript:hapus(\"{$id_room}\")' class='text-danger'>
