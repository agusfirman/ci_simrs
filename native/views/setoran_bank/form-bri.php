<h3 style="margin-top:80px" class="text-center text-red"> FORM BUKTI SETORAN || BANK BRI</h3>
<hr/>
<form id="form_bri" class="form-horizontal" action="cetak/print-out-bri.php" method="post" target="_blank" >
	...
	<label class="col-sm-3 control-label">Nama Pemilik Rekening</label>
		<div class="col-sm-3">
		  <select class="form-control input-sm" name="nama"  id="nama" autofocus>
		  	...
		  	$result =$mysqli->query("select id, nama_dokter from dt_dokter order by nama_dokter ASC");
  ...
  <div class="form-group">
		...
		<div class="col-sm-4">
			<input type="text" class="form-control input-sm" name="nama_bank"  id="nama_bank" placeholder="Nama BANK" readonly>
		</div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
	...
	<div class="col-sm-4">
	  <input type="text" class="form-control input-sm" name="nama_penyetor" id="nama_penyetor"  placeholder="Nama Penyetor" readonly value="PT. Family Bahagia Sejahtera">
	</div>
  </div>
 <div class="form-group">
