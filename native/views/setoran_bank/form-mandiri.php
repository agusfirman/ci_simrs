...
<hr/>
<!--action="cetak/print-out-mandiri.php" target="_blank" -->
<form id="form_cimb" class="form-horizontal"  method="post"  >
...
$(document).ready(function(){
	...
	$("#btn_cetak_cimb").click(function(event) {
    	var nama_dokter = $('.nama option:selected').text();
    	var norek = $('.norek').val();
      ...
      var nama_bank_text = $('.nama_bank option:selected').text();
        ...
        var url = 'views/setoran_bank/pop-print-out-mandiri.php?norek='+norek+'&nama='+nama_dokter+'&nama_penyetor='+nama_penyetor+'&alm_penyetor='+alm_penyetor+'&telp='+telp+'&nom='+nom;
